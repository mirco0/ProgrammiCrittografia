...
\noindent
\textbf{N.B.} L'algoritmo seguente fa uso di dizionari (strutture dati, che in python hanno una complessità di \textit{lookup} $O(1)$)

\subsubsection*{Calcolo logartimo discreto}
Qui segue l'esecuzione dell'algoritmo per il primo logarimo discreto dell'esercizio:
...
\[
    \log_{106}(12375) = (158 \cdot 141 + 114) \mod 24691 = 22392
\]

Analogamente si procede con il secondo punto dell'esercizio, ovvero il calcolo di $\log_6(248388)$ in ${\mathbb{Z}_{458009}$, 
