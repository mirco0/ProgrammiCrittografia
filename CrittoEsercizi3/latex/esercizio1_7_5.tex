...
Da come si può notare, in questo caso il calcolo di $a$ ($ a= \sum_{i = 0}^{c-1}a_iq^i$) per le singole esecuzioni sui diversi fattori non è banale. Segue un breve calcolo delle diverse a per la creazione del sistema
